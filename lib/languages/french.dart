...
const Map<BibleBookEnum, List<String>> frenchBookNames = {
  ...
  BibleBookEnum.lamentations: [
    ...
    'Livre des lamentations de Jeremie'
  ],
  ...
  BibleBookEnum.matthew: [
    ...
    'Evangile de Jesus-Christ selon saint Matthieu'
  ],
  BibleBookEnum.mark: [
    'Marc',
    'Évangile selon Marc',
  ...
  BibleBookEnum.firstThessalonians: [
    ...
    'Premiere lettre aux Thessaloniciens'
  ],
  BibleBookEnum.secondThessalonians: [
    '2 Thessaloniciens',
    'II Thessaloniciens',
    'Deuxième lettre aux Thessaloniciens',
    'Deuxieme lettre aux Thessaloniciens'
  ],
  ...
  BibleBookEnum.secondMaccabees: [
    ...
    'Deuxieme Livre des Martyrs d\'Israël'
  ],
  ...
  BibleBookEnum.danielSongOfThree: [
    ...
    'Cantique des trois amis de Daniel',
